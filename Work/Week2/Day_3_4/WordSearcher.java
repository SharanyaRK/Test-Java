/** 
* Program take in a text file and a search word as input. 
* The program write output file with the line number and the start indices of the search term 
...
public class WordSearcher {
    ...
    private void searchAndWritePerfectMatch(){
        try {
            PrintWriter pw = new PrintWriter(new FileWriter(inputWord+".locations"+".txt"),false);
