...
public final class editContact_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                                    <input type=\"text\" class=\"input-box\" name=\"firstname\" maxlength=\"10\" value=\"\" placeholder=\"First Name\" required>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div id=\"user-input-lastname-box\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"input-box\" name=\"lastname\" maxlength=\"10\" value=\"\" placeholder=\"Last Name\" required>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"email\" id=\"email-input-box\" name=\"email_id\" value=\"\" readonly>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div id=\"email-label-box\">Email:</div>\n");
      out.write("\t\t\t\t\t<div id=\"email-box\">\n");
      out.write("\t\t\t\t\t\t<input type=\"email\" id=\"email-input-box\" name=\"email_id\" value=\"\" readonly>\n");
      ...
      out.write("                                                    <input type=\"text\" class=\"address-input-box\" name=\"address_line_1\" value=\"\" placeholder=\"Address Line 1\" required>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div id=\"address-line\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"address-input-box\" name=\"address_line_2\" value=\"\" placeholder=\"Address Line 2\" required>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div id=\"address-line\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"input-box\" name=\"city\" value=\"\" placeholder=\"City\" required>\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div id=\"address-line\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"input-box\" maxlength=\"10\" name=\"zip\" value=\"\" placeholder=\"Zip\" required>\n");
